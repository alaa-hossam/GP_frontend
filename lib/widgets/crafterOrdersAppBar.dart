...
class CrafterOrdersAppBar extends StatelessWidget implements PreferredSizeWidget {
  final int index;
  final void Function(int) onTabSelected;

  CrafterOrdersAppBar({super.key, required this.index, required this.onTabSelected});
      ...
      children: [
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              appBarContainer("Complete", index, 0, onTabSelected),
              SizedBox(width: 20 * SizeConfig.horizontalBlock),
              appBarContainer("Active", index, 1, onTabSelected),
            ],
          ),
        ),

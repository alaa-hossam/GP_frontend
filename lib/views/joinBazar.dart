        ...
        children: [
                  ...
                  return Padding(
                    ...
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isTapped = tappedProducts
                            .contains(product.id); // Check if product is tapped
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color:
                                Color(0x50E9E9E9), // Container background color
                            // boxShadow: [
                            //   BoxShadow(
          ...
          Positioned(
            ...
            child: customizeButton(
              ...
              onClickButton: () {
                Navigator.pushNamed(
                    context, arguments: tappedProducts, BazarVariations.id);
              },
            ),
          )
        ],
